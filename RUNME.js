//for this to work, you must place the area div in the head tag, under the title and icon tags.
// You also must place this small line of code under <!DOCTYPE HTML>
const area = document.getElementById('area');
//to make it run faster it runs based on export
area.innerHTML = "<meta charset="UTF-8" />
...
<script src="style.js"><div id="style"></div></script>
  <script type="text/javascript">
"use strict";
(function(){
...
<h2 id="gameWillLaunchIn">ePlay SunBeam will launch in <span id="launchCountdownNumber">5</span>...</h2>
...
<p style="margin-top:30px;"><button id="bootMenu">Enter Boot Menu</button></p></div>
</div>
</div>
</body>
</html>
